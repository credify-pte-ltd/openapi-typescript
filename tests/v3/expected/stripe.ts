...
export interface components {
  ...
  account: {
    ...
    businessProfile?: Partial<components["account_business_profile"]> | null;
    /** The business type. */
    businessType?:
      | ("company" | "government_entity" | "individual" | "non_profit")
      | null;
    capabilities?: components["account_capabilities"];
    /** Whether the account can create live charges. */
    chargesEnabled?: boolean;
    company?: components["legal_entity_company"];
    ...
    externalAccounts?: {
      ...
      data: (Partial<components["bank_account"]> &
    ...
    requirements?: components["account_requirements"];
    /** Options for customizing how the account functions within Stripe. */
    settings?: Partial<components["account_settings"]> | null;
    tosAcceptance?: components["account_tos_acceptance"];
    /** The Stripe account type. Can be `standard`, `express`, or `custom`. */
    type?: "custom" | "express" | "standard";
  };
  accountBrandingSettings: {
    /** (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) An icon for the account. Must be square and at least 128px x 128px. */
    icon?: (Partial<string> & Partial<components["file"]>) | null;
    /** (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) A logo for the account that will be used in Checkout instead of the icon and without the account's name next to it if provided. Must be at least 128px x 128px. */
    logo?: (Partial<string> & Partial<components["file"]>) | null;
  ...
  accountBusinessProfile: {
    ...
    supportAddress?: Partial<components["address"]> | null;
  ...
  accountCapabilities: {
    ...
    auBecsDebitPayments?: "active" | "inactive" | "pending";
    /** The status of the card issuing capability of the account, or whether you can use Issuing to distribute funds on cards */
    cardIssuing?: "active" | "inactive" | "pending";
    /** The status of the card payments capability of the account, or whether the account can directly process credit and debit card charges. */
    cardPayments?: "active" | "inactive" | "pending";
    /** The status of the legacy payments capability of the account. */
    legacyPayments?: "active" | "inactive" | "pending";
    /** The status of the tax reporting 1099-K (US) capability of the account. */
    taxReportingUs_1099K?: "active" | "inactive" | "pending";
    /** The status of the tax reporting 1099-MISC (US) capability of the account. */
    taxReportingUs_1099Misc?: "active" | "inactive" | "pending";
  ...
  accountCapabilityRequirements: {
    ...
    errors: components["account_requirements_error"][];
  ...
  accountCardPaymentsSettings: {
    declineOn?: components["account_decline_charge_on"];
  ...
  accountPayoutSettings: {
    ...
    schedule: components["transfer_schedule"];
  ...
  accountRequirements: {
    ...
    disabledReason?: string | null;
    /** The fields that need to be collected again because validation or verification failed for some reason. */
    errors?: components["account_requirements_error"][] | null;
    /** The fields that need to be collected assuming all volume thresholds are reached. As they become required, these fields appear in `currently_due` as well, and the `current_deadline` is set. */
  ...
  accountSettings: {
    branding: components["account_branding_settings"];
    cardPayments: components["account_card_payments_settings"];
    dashboard: components["account_dashboard_settings"];
    payments: components["account_payments_settings"];
    payouts?: components["account_payout_settings"];
  };
  ...
  alipayAccount: {
    ...
    customer?:
      | (Partial<string> &
      Partial<components["customer"]> &
      Partial<components["deleted_customer"]>)
      | null;
  ...
  apiErrors: {
    ...
    param?: string;
    paymentIntent?: components["payment_intent"];
    paymentMethod?: components["payment_method"];
    setupIntent?: components["setup_intent"];
    /** The source object for errors returned on a request involving a source. */
    source?: Partial<components["bank_account"]> &
      Partial<components["card"]> &
      Partial<components["source"]>;
  ...
  applicationFee: {
    ...
    account: Partial<string> & Partial<components["account"]>;
    /** Amount earned, in %s. */
    amount: number;
    /** Amount in %s refunded (can be less than the amount attribute on the fee if a partial refund was issued) */
    amountRefunded: number;
    /** ID of the Connect application that earned the fee. */
    application: Partial<string> & Partial<components["application"]>;
    /** Balance transaction that describes the impact of this collected application fee on your account balance (not including refunds). */
    balanceTransaction?:
      | (Partial<string> & Partial<components["balance_transaction"]>)
      | null;
    /** ID of the charge that the application fee was taken from. */
    charge: Partial<string> & Partial<components["charge"]>;
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    ...
    originatingTransaction?:
      | (Partial<string> & Partial<components["charge"]>)
      | null;
  ...
  balance: {
    ...
    available: components["balance_amount"][];
    /** Funds held due to negative balances on connected Custom accounts. The connect reserve balance for each currency and payment type can be found in the `source_types` property. */
    connectReserved?: components["balance_amount"][];
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "balance";
    /** Funds that are not yet available in the balance, due to the 7-day rolling pay cycle. The pending balance for each currency, and for each payment type, can be found in the `source_types` property. */
    pending: components["balance_amount"][];
  };
  balanceAmount: {
    /** Balance amount. */
    amount: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
    sourceTypes?: components["balance_amount_by_source_type"];
  };
  ...
  balanceTransaction: {
    ...
    source?:
      | (Partial<string> &
      Partial<components["application_fee"]> &
      Partial<components["charge"]> &
      Partial<components["connect_collection_transfer"]> &
      Partial<components["dispute"]> &
      Partial<components["fee_refund"]> &
      Partial<components["issuing.authorization"]> &
      Partial<components["issuing.transaction"]> &
      Partial<components["payout"]> &
      Partial<components["platform_tax_fee"]> &
      Partial<components["refund"]> &
      Partial<components["reserve_transaction"]> &
      Partial<components["tax_deducted_at_source"]> &
      Partial<components["topup"]> &
      Partial<components["transfer"]> &
      Partial<components["transfer_reversal"]>)
      | null;
  ...
  bankAccount: {
    ...
    account?: (Partial<string> & Partial<components["account"]>) | null;
  ...
  billingDetails: {
    /** Billing address. */
    address?: Partial<components["address"]> | null;
    /** Email address. */
    email?: string | null;
    /** Full name. */
    name?: string | null;
  ...
  bitcoinReceiver: {
    ...
    transactions?: {
      /** Details about each object. */
      data: components["bitcoin_transaction"][];
      /** True if this list has another page of items after this one that can be fetched. */
      hasMore: boolean;
      /** String representing the object's type. Objects of the same type share the same value. Always has the value `list`. */
      object: "list";
  ...
  capability: {
    ...
    requirements?: components["account_capability_requirements"];
  ...
  card: {
    ...
    availablePayoutMethods?: ("instant" | "standard")[] | null;
    ...
    recipient?: (Partial<string> & Partial<components["recipient"]>) | null;
  ...
  cardMandatePaymentMethodDetails: { [key: string]: any };
  /**
  ...
  charge: {
    ...
    application?: (Partial<string> & Partial<components["application"]>) | null;
    /** The application fee (if any) for the charge. [See the Connect documentation](https://stripe.com/docs/connect/direct-charges#collecting-fees) for details. */
    applicationFee?:
      | (Partial<string> & Partial<components["application_fee"]>)
      | null;
    ...
    balanceTransaction?:
      | (Partial<string> & Partial<components["balance_transaction"]>)
      | null;
    billingDetails: components["billing_details"];
    ...
    fraudDetails?: Partial<components["charge_fraud_details"]> | null;
    /** Unique identifier for the object. */
    id: string;
    /** ID of the invoice this charge is for if one exists. */
    invoice?: (Partial<string> & Partial<components["invoice"]>) | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
    ...
    onBehalfOf?: (Partial<string> & Partial<components["account"]>) | null;
    /** ID of the order this charge is for if one exists. */
    order?: (Partial<string> & Partial<components["order"]>) | null;
    /** Details about whether the payment was accepted, and why. See [understanding declines](https://stripe.com/docs/declines) for details. */
    outcome?: Partial<components["charge_outcome"]> | null;
    /** `true` if the charge succeeded, or was successfully authorized for later capture. */
    paid: boolean;
    /** ID of the PaymentIntent associated with this charge, if one exists. */
    paymentIntent?:
      | (Partial<string> & Partial<components["payment_intent"]>)
      | null;
    /** ID of the payment method used in this charge. */
    paymentMethod?: string | null;
    /** Details about the payment method at the time of the transaction. */
    paymentMethodDetails?: Partial<components["payment_method_details"]> | null;
    ...
    review?: (Partial<string> & Partial<components["review"]>) | null;
    /** Shipping information for the charge. */
    shipping?: Partial<components["shipping"]> | null;
    /** The transfer ID which created this charge. Only present if the charge came from another Stripe account. [See the Connect documentation](https://stripe.com/docs/connect/destination-charges) for details. */
    sourceTransfer?: (Partial<string> & Partial<components["transfer"]>) | null;
    ...
    transfer?: Partial<string> & Partial<components["transfer"]>;
    /** An optional dictionary including the account to automatically transfer to as part of a destination charge. [See the Connect documentation](https://stripe.com/docs/connect/destination-charges) for details. */
    transferData?: Partial<components["charge_transfer_data"]> | null;
  ...
  chargeOutcome: {
    ...
    rule?: Partial<string> & Partial<components["rule"]>;
  ...
  chargeTransferData: {
    ...
    destination: Partial<string> & Partial<components["account"]>;
  };
  /**
  ...
  "checkout.session": {
     ...
     */
    customer?: (Partial<string> & Partial<components["customer"]>) | null;
    /**
    ...
    displayItems?: components["checkout_session_display_item"][] | null;
    /**
    ...
    setupIntent?:
      | (Partial<string> & Partial<components["setup_intent"]>)
      | null;
    /** Shipping information for this Checkout Session. */
    shipping?: Partial<components["shipping"]> | null;
    /** When set, provides configuration for Checkout to collect a shipping address from a customer. */
    shippingAddressCollection?: Partial<
      components["payment_pages_payment_page_resources_shipping_address_collection"]
      > | null;
    /**
     ...
     */
    submitType?: ("auto" | "book" | "donate" | "pay") | null;
    /** The ID of the subscription for Checkout Sessions in `subscription` mode. */
    subscription?:
      | (Partial<string> & Partial<components["subscription"]>)
      | null;
    /**
  ...
  checkoutSessionDisplayItem: {
    ...
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency?: string;
    custom?: components["checkout_session_custom_display_item_description"];
  ...
  countrySpec: {
    ...
    supportedBankAccountCurrencies: { [key: string]: string[] };
    ...
    verificationFields: components["country_spec_verification_fields"];
  };
  ...
  countrySpecVerificationFields: {
    company: components["country_spec_verification_field_details"];
    individual: components["country_spec_verification_field_details"];
  };
  /**
  ...
  creditNote: {
    ...
    currency: string;
    /** ID of the customer. */
    customer: Partial<string> & Partial<components["customer"]>;
    /** Customer balance transaction related to this credit note. */
    customerBalanceTransaction?:
      | (Partial<string> & Partial<components["customer_balance_transaction"]>)
      | null;
    ...
    id: string;
    /** ID of the invoice. */
    invoice: Partial<string> & Partial<components["invoice"]>;
    /** Line items that make up the credit note */
    lines: {
      /** Details about each object. */
      data: components["credit_note_line_item"][];
      /** True if this list has another page of items after this one that can be fetched. */
      hasMore: boolean;
      /** String representing the object's type. Objects of the same type share the same value. Always has the value `list`. */
      object: "list";
    ...
    refund?: (Partial<string> & Partial<components["refund"]>) | null;
    ...
    taxAmounts: components["credit_note_tax_amount"][];
  ...
  creditNoteTaxAmount: {
    ...
    taxRate: Partial<string> & Partial<components["tax_rate"]>;
  };
  /**
  ...
  customer: {
    ...
    defaultSource?:
      | (Partial<string> &
      Partial<components["alipay_account"]> &
      Partial<components["bank_account"]> &
      Partial<components["bitcoin_receiver"]> &
      Partial<components["card"]> &
      Partial<components["source"]>)
      | null;
    ...
    discount?: Partial<components["discount"]> | null;
    ...
    invoiceSettings?: components["invoice_setting_customer_setting"];
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata?: { [key: string]: string };
    ...
    sources: {
      /** Details about each object. */
      data: (Partial<components["alipay_account"]> &
        Partial<components["bank_account"]> &
        Partial<components["bitcoin_receiver"]> &
        Partial<components["card"]> &
        Partial<components["source"]>)[];
  ...
  customerAcceptance: {
    ...
    offline?: components["offline_acceptance"];
    online?: components["online_acceptance"];
  ...
  customerBalanceTransaction: {
    ...
    creditNote?: (Partial<string> & Partial<components["credit_note"]>) | null;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
  ...
  deletedExternalAccount: Partial<components["deleted_bank_account"]> &
    Partial<components["deleted_card"]>;
  deletedInvoice: {
    /** Always true for a deleted object */
    deleted: true;
    /** Unique identifier for the object. */
  ...
  deletedPaymentSource: Partial<components["deleted_alipay_account"]> &
    Partial<components["deleted_bank_account"]> &
    Partial<components["deleted_bitcoin_receiver"]> &
    Partial<components["deleted_card"]>;
  deletedPerson: {
    /** Always true for a deleted object */
    deleted: true;
  ...
  dispute: {
    ...
    balanceTransactions: components["balance_transaction"][];
    ...
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
    evidence: components["dispute_evidence"];
    evidenceDetails: components["dispute_evidence_details"];
    /** Unique identifier for the object. */
    id: string;
  ...
  disputeEvidence: {
    ...
    cancellationPolicy?: (Partial<string> & Partial<components["file"]>) | null;
    ...
    customerCommunication?:
      | (Partial<string> & Partial<components["file"]>)
      | null;
    ...
    customerSignature?: (Partial<string> & Partial<components["file"]>) | null;
    ...
    receipt?: (Partial<string> & Partial<components["file"]>) | null;
    /** (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Your refund policy, as shown to the customer. */
    refundPolicy?: (Partial<string> & Partial<components["file"]>) | null;
    ...
    uncategorizedFile?: (Partial<string> & Partial<components["file"]>) | null;
  ...
  event: {
    ...
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    data: components["notification_event_data"];
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    ...
    request?: Partial<components["notification_event_request"]> | null;
  ...
  externalAccount: Partial<components["bank_account"]> &
    Partial<components["card"]>;
  fee: {
  ...
  feeRefund: {
    ...
    fee: Partial<string> & Partial<components["application_fee"]>;
    /** Unique identifier for the object. */
    id: string;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
  ...
  fileLink: {
    ...
    file: Partial<string> & Partial<components["file"]>;
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
  ...
  invoice: {
    ...
    charge?: (Partial<string> & Partial<components["charge"]>) | null;
    ...
    customFields?: components["invoice_setting_custom_field"][] | null;
    /** The ID of the customer who will be billed. */
    customer: Partial<string> &
      Partial<components["customer"]> &
      Partial<components["deleted_customer"]>;
    /** The customer's address. Until the invoice is finalized, this field will equal `customer.address`. Once the invoice is finalized, this field will no longer be updated. */
    customerAddress?: Partial<components["address"]> | null;
    ...
    defaultTaxRates?: components["tax_rate"][] | null;
    ...
    status?:
      ...
      | null;
    statusTransitions: components["invoices_status_transitions"];
    ...
    thresholdReason?: components["invoice_threshold_reason"];
    /** Total after discounts and taxes. */
    total: number;
    /** The aggregate amounts calculated per tax rate for all line items. */
    totalTaxAmounts?: components["invoice_tax_amount"][] | null;
  ...
  invoiceThresholdReason: {
    ...
    itemReasons: components["invoice_item_threshold_reason"][];
  };
  /**
  ...
  invoiceitem: {
    ...
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "invoiceitem";
    period: components["invoice_line_item_period"];
    /** If the invoice item is a proration, the plan of the subscription that the proration was computed for. */
    plan?: Partial<components["plan"]> | null;
    ...
    taxRates?: components["tax_rate"][] | null;
  ...
  "issuing.authorization": {
    ...
    balanceTransactions: components["balance_transaction"][];
    card: components["issuing.card"];
    /** The cardholder to whom this authorization belongs. */
    cardholder?:
      | (Partial<string> & Partial<components["issuing.cardholder"]>)
      | null;
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    ...
    merchantData: components["issuing_authorization_merchant_data"];
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
    /** String representing the object's type. Objects of the same type share the same value. */
    ...
    pendingRequest?: Partial<
      components["issuing_authorization_pending_request"]
      > | null;
    ...
    requestHistory: components["issuing_authorization_request"][];
    /** The current status of the authorization in its lifecycle. */
    status: "closed" | "pending" | "reversed";
    /** List of [transactions](https://stripe.com/docs/api/issuing/transactions) associated with this authorization. */
    transactions: components["issuing.transaction"][];
    verificationData: components["issuing_authorization_verification_data"];
  ...
  "issuing.card": {
    ...
    cancellationReason?: ("lost" | "stolen") | null;
    cardholder: components["issuing.cardholder"];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
    ...
    replacedBy?: (Partial<string> & Partial<components["issuing.card"]>) | null;
    /** The card this card replaces, if any. */
    replacementFor?:
      | (Partial<string> & Partial<components["issuing.card"]>)
      | null;
    /** The reason why the previous card needed to be replaced. */
    replacementReason?: ("damaged" | "expired" | "lost" | "stolen") | null;
    /** Where and how the card will be shipped. */
    shipping?: Partial<components["issuing_card_shipping"]> | null;
    spendingControls: components["issuing_card_authorization_controls"];
   ...
   */
  "issuing.cardholder": {
    billing: components["issuing_cardholder_address"];
    /** Additional information about a `company` cardholder. */
    company?: Partial<components["issuing_cardholder_company"]> | null;
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    ...
    individual?: Partial<components["issuing_cardholder_individual"]> | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
    ...
    requirements: components["issuing_cardholder_requirements"];
    ...
    spendingControls?: Partial<
      components["issuing_cardholder_authorization_controls"]
      > | null;
  ...
  "issuing.transaction": {
    ...
    authorization?:
      | (Partial<string> & Partial<components["issuing.authorization"]>)
      | null;
    ...
    card: Partial<string> & Partial<components["issuing.card"]>;
  ...
  issuingCardAuthorizationControls: {
    ...
    spendingLimits?: components["issuing_card_spending_limit"][] | null;
  ...
  issuingCardholderAuthorizationControls: {
    ...
    blockedCategories?:
      ...
      | null;
    /** Limit the spending with rules based on time intervals and categories. */
    spendingLimits?: components["issuing_cardholder_spending_limit"][] | null;
  ...
  issuingCardholderIdDocument: {
    ...
    back?: (Partial<string> & Partial<components["file"]>) | null;
    /** The front of a document returned by a [file upload](https://stripe.com/docs/api#create_file) with a `purpose` value of `identity_document`. */
    front?: (Partial<string> & Partial<components["file"]>) | null;
  };
  issuingCardholderIndividual: {
    /** The date of birth of this cardholder. */
    dob?: Partial<components["issuing_cardholder_individual_dob"]> | null;
    ...
    verification?: Partial<
      components["issuing_cardholder_verification"]
      > | null;
  };
  ...
  issuingCardholderRequirements: {
    ...
    disabledReason?: ("listed" | "rejected.listed" | "under_review") | null;
  ...
  issuingCardholderVerification: {
    ...
    document?: Partial<components["issuing_cardholder_id_document"]> | null;
  };
  legalEntityCompany: {
    address?: components["address"];
    /** The Kana variation of the company's primary address (Japan only). */
    addressKana?: Partial<components["legal_entity_japan_address"]> | null;
    /** The Kanji variation of the company's primary address (Japan only). */
    addressKanji?: Partial<components["legal_entity_japan_address"]> | null;
    ...
    verification?: Partial<
      components["legal_entity_company_verification"]
      > | null;
  };
  legalEntityCompanyVerification: {
    document: components["legal_entity_company_verification_document"];
  };
  ...
  legalEntityPersonVerification: {
    ...
    additionalDocument?: Partial<
      components["legal_entity_person_verification_document"]
      > | null;
    /** A user-displayable string describing the verification state for the person. For example, this may say "Provided identity information could not be verified". */
    details?: string | null;
    /** One of `document_address_mismatch`, `document_dob_mismatch`, `document_duplicate_type`, `document_id_number_mismatch`, `document_name_mismatch`, `document_nationality_mismatch`, `failed_keyed_identity`, or `failed_other`. A machine-readable code specifying the verification state for the person. */
    detailsCode?: string | null;
    document?: components["legal_entity_person_verification_document"];
  ...
  lightAccountLogout: { [key: string]: any };
  lineItem: {
    /** The amount, in %s. */
    amount: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    ...
    subscriptionItem?: string;
    /** The amount of tax calculated per tax rate for this line item */
    taxAmounts?: components["invoice_tax_amount"][] | null;
    /** The tax rates which apply to the line item. */
    taxRates?: components["tax_rate"][] | null;
  ...
  mandate: {
    customerAcceptance: components["customer_acceptance"];
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    multiUse?: components["mandate_multi_use"];
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "mandate";
    /** ID of the payment method associated with this mandate. */
    paymentMethod: Partial<string> & Partial<components["payment_method"]>;
    paymentMethodDetails: components["mandate_payment_method_details"];
    singleUse?: components["mandate_single_use"];
  ...
  mandateMultiUse: { [key: string]: any };
  mandatePaymentMethodDetails: {
    auBecsDebit?: components["mandate_au_becs_debit"];
    card?: components["card_mandate_payment_method_details"];
    sepaDebit?: components["mandate_sepa_debit"];
  ...
  notificationEventData: {
    ...
    previousAttributes?: { [key: string]: any };
  };
  ...
  offlineAcceptance: { [key: string]: any };
  onlineAcceptance: {
  ...
  order: {
    ...
    shippingMethods?: components["shipping_method"][] | null;
    ...
    statusTransitions?: Partial<components["status_transitions"]> | null;
  ...
  orderItem: {
    ...
    parent?: (Partial<string> & Partial<components["sku"]>) | null;
  ...
  paymentIntent: {
    ...
    lastPaymentError?: Partial<components["api_errors"]> | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    ...
    nextAction?: Partial<components["payment_intent_next_action"]> | null;
    /** String representing the object's type. Objects of the same type share the same value. */
    ...
    paymentMethodOptions?: Partial<
      components["payment_intent_payment_method_options"]
      > | null;
    ...
    transferData?: Partial<components["transfer_data"]> | null;
    /** A string that identifies the resulting payment as part of a group. See the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/connected-accounts) for details. */
    transferGroup?: string | null;
  };
  paymentIntentNextAction: {
    redirectToUrl?: components["payment_intent_next_action_redirect_to_url"];
    /** Type of the next action to perform, one of `redirect_to_url` or `use_stripe_sdk`. */
    type: string;
    /** When confirming a PaymentIntent with Stripe.js, Stripe.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by Stripe.js. */
    useStripeSdk?: { [key: string]: any };
  };
  ...
  paymentIntentPaymentMethodOptions: {
    card?: components["payment_intent_payment_method_options_card"];
  };
   ...
   */
  paymentMethod: {
    auBecsDebit?: components["payment_method_au_becs_debit"];
    billingDetails: components["billing_details"];
    card?: components["payment_method_card"];
    cardPresent?: components["payment_method_card_present"];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** The ID of the Customer to which this PaymentMethod is saved. This will not be set when the PaymentMethod has not been saved to a Customer. */
    customer?: (Partial<string> & Partial<components["customer"]>) | null;
    fpx?: components["payment_method_fpx"];
    /** Unique identifier for the object. */
    id: string;
    ideal?: components["payment_method_ideal"];
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
    ...
    sepaDebit?: components["payment_method_sepa_debit"];
  ...
  paymentMethodCard: {
    ...
    checks?: Partial<components["payment_method_card_checks"]> | null;
    /** Two-letter ISO code representing the country of the card. You could use this attribute to get a sense of the international breakdown of cards you've collected. */
    country?: string | null;
    /** Two-digit number representing the card's expiration month. */
    expMonth: number;
    ...
    generatedFrom?: Partial<
      components["payment_method_card_generated_card"]
      > | null;
    /** The last four digits of the card. */
    last4: string;
    /** Contains details on how this Card maybe be used for 3D Secure authentication. */
    threeDSecureUsage?: Partial<components["three_d_secure_usage"]> | null;
    /** If this Card is part of a card wallet, this contains the details of the card wallet. */
    wallet?: Partial<components["payment_method_card_wallet"]> | null;
  };
  ...
  paymentMethodCardPresent: { [key: string]: any };
  paymentMethodCardWallet: {
    amexExpressCheckout?: components["payment_method_card_wallet_amex_express_checkout"];
    applePay?: components["payment_method_card_wallet_apple_pay"];
    /** (For tokenized numbers only.) The last four digits of the device account number. */
    dynamicLast4?: string | null;
    googlePay?: components["payment_method_card_wallet_google_pay"];
    masterpass?: components["payment_method_card_wallet_masterpass"];
    samsungPay?: components["payment_method_card_wallet_samsung_pay"];
    ...
    type:
      ...
      | "samsung_pay"
      | "visa_checkout";
    visaCheckout?: components["payment_method_card_wallet_visa_checkout"];
  };
  paymentMethodCardWalletAmexExpressCheckout: { [key: string]: any };
  paymentMethodCardWalletApplePay: { [key: string]: any };
  paymentMethodCardWalletGooglePay: { [key: string]: any };
  paymentMethodCardWalletMasterpass: {
    /** Owner's verified billing address. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. */
    billingAddress?: Partial<components["address"]> | null;
    /** Owner's verified email. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. */
    email?: string | null;
    /** Owner's verified full name. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. */
    name?: string | null;
    /** Owner's verified shipping address. Values are verified or provided by the wallet directly (if supported) at the time of authorization or settlement. They cannot be set or mutated. */
    shippingAddress?: Partial<components["address"]> | null;
  };
  paymentMethodCardWalletSamsungPay: { [key: string]: any };
  ...
  paymentMethodDetails: {
    achCreditTransfer?: components["payment_method_details_ach_credit_transfer"];
    achDebit?: components["payment_method_details_ach_debit"];
    alipay?: components["payment_method_details_alipay"];
    auBecsDebit?: components["payment_method_details_au_becs_debit"];
    bancontact?: components["payment_method_details_bancontact"];
    card?: components["payment_method_details_card"];
    cardPresent?: components["payment_method_details_card_present"];
    eps?: components["payment_method_details_eps"];
    fpx?: components["payment_method_details_fpx"];
    giropay?: components["payment_method_details_giropay"];
    ideal?: components["payment_method_details_ideal"];
    klarna?: components["payment_method_details_klarna"];
    multibanco?: components["payment_method_details_multibanco"];
    p24?: components["payment_method_details_p24"];
    sepaDebit?: components["payment_method_details_sepa_debit"];
    sofort?: components["payment_method_details_sofort"];
    stripeAccount?: components["payment_method_details_stripe_account"];
    /**
     ...
     */
    type: string;
    wechat?: components["payment_method_details_wechat"];
  };
  ...
  paymentMethodDetailsAlipay: { [key: string]: any };
  ...
  paymentMethodDetailsBancontact: {
     ...
     */
    preferredLanguage?: ("de" | "en" | "fr" | "nl") | null;
    /**
  ...
  paymentMethodDetailsCard: {
    ...
    checks?: Partial<components["payment_method_details_card_checks"]> | null;
    /** Two-letter ISO code representing the country of the card. You could use this attribute to get a sense of the international breakdown of cards you've collected. */
    country?: string | null;
    /** Two-digit number representing the card's expiration month. */
     ...
     */
    installments?: Partial<
      components["payment_method_details_card_installments"]
      > | null;
    /** The last four digits of the card. */
    last4?: string | null;
    ...
    threeDSecure?: Partial<components["three_d_secure_details"]> | null;
    /** If this Card is part of a card wallet, this contains the details of the card wallet. */
    wallet?: Partial<components["payment_method_details_card_wallet"]> | null;
  };
  ...
  paymentMethodDetailsCardInstallments: {
    ...
    plan?: Partial<
      components["payment_method_details_card_installments_plan"]
      > | null;
  };
  ...
  paymentMethodDetailsCardPresent: {
    ...
    receipt?: Partial<
      components["payment_method_details_card_present_receipt"]
      > | null;
  };
  ...
  paymentMethodDetailsCardWallet: {
    amexExpressCheckout?: components["payment_method_details_card_wallet_amex_express_checkout"];
    applePay?: components["payment_method_details_card_wallet_apple_pay"];
    /** (For tokenized numbers only.) The last four digits of the device account number. */
    dynamicLast4?: string | null;
    googlePay?: components["payment_method_details_card_wallet_google_pay"];
    masterpass?: components["payment_method_details_card_wallet_masterpass"];
    samsungPay?: components["payment_method_details_card_wallet_samsung_pay"];
    /** The type of the card wallet, one of `amex_express_checkout`, `apple_pay`, `google_pay`, `masterpass`, `samsung_pay`, or `visa_checkout`. An additional hash is included on the Wallet subhash with a name matching this value. It contains additional information specific to the card wallet type. */
    type:
      | "amex_express_checkout"
      | "apple_pay"
      ...
      | "samsung_pay"
      | "visa_checkout";
    visaCheckout?: components["payment_method_details_card_wallet_visa_checkout"];
  };
  paymentMethodDetailsCardWalletAmexExpressCheckout: { [key: string]: any };
  paymentMethodDetailsCardWalletApplePay: { [key: string]: any };
  paymentMethodDetailsCardWalletGooglePay: { [key: string]: any };
  ...
  paymentMethodDetailsCardWalletSamsungPay: { [key: string]: any };
  ...
  paymentMethodDetailsKlarna: { [key: string]: any };
  ...
  paymentMethodDetailsStripeAccount: { [key: string]: any };
  paymentMethodDetailsWechat: { [key: string]: any };
  paymentMethodFpx: {
  ...
  paymentSource: Partial<components["account"]> &
    Partial<components["alipay_account"]> &
    Partial<components["bank_account"]> &
    Partial<components["bitcoin_receiver"]> &
    Partial<components["card"]> &
  ...
  person: {
    ...
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    dob?: components["legal_entity_dob"];
    email?: string | null;
    ...
    object: "person";
    phone?: string | null;
    relationship?: components["person_relationship"];
    requirements?: Partial<components["person_requirements"]> | null;
    ssnLast_4Provided?: boolean;
    verification?: components["legal_entity_person_verification"];
  };
  personRelationship: {
  ...
  plan: {
    ...
    product?:
      | (Partial<string> &
      Partial<components["product"]> &
      Partial<components["deleted_product"]>)
      | null;
    /** Each element represents a pricing tier. This parameter requires `billing_scheme` to be set to `tiered`. See also the documentation for `billing_scheme`. */
    tiers?: components["plan_tier"][] | null;
    /** Defines if the tiering price should be `graduated` or `volume` based. In `volume`-based tiering, the maximum quantity within a period determines the per unit price. In `graduated` tiering, pricing can change as the quantity grows. */
    tiersMode?: ("graduated" | "volume") | null;
    /** Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with `tiers`. */
    transformUsage?: Partial<components["transform_usage"]> | null;
  ...
  product: {
    ...
    packageDimensions?: Partial<components["package_dimensions"]> | null;
  ...
  "radar.valueList": {
    ...
    listItems: {
      /** Details about each object. */
      data: components["radar.value_list_item"][];
      /** True if this list has another page of items after this one that can be fetched. */
      hasMore: boolean;
      /** String representing the object's type. Objects of the same type share the same value. Always has the value `list`. */
      object: "list";
  ...
  recipient: {
    ...
    activeAccount?: Partial<components["bank_account"]> | null;
    cards?: {
    ...
    defaultCard?: (Partial<string> & Partial<components["card"]>) | null;
    /** An arbitrary string attached to the object. Often useful for displaying to users. */
    description?: string | null;
    email?: string | null;
    /** Unique identifier for the object. */
    ...
    migratedTo?: (Partial<string> & Partial<components["account"]>) | null;
    /** Full, legal name of the recipient. */
    name?: string | null;
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "recipient";
    rolledBackFrom?: Partial<string> & Partial<components["account"]>;
  ...
  refund: {
    ...
    failureBalanceTransaction?: Partial<string> &
      Partial<components["balance_transaction"]>;
    ...
    sourceTransferReversal?:
      | (Partial<string> & Partial<components["transfer_reversal"]>)
      | null;
  ...
  "reporting.reportRun": {
    ...
    parameters: components["financial_reporting_finance_report_run_run_parameters"];
     ...
     *  `status=succeeded`).
     */
    result?: Partial<components["file"]> | null;
    /**
  ...
  review: {
    ...
    ipAddressLocation?: Partial<
      components["radar_review_resource_location"]
      > | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** String representing the object's type. Objects of the same type share the same value. */
    ...
    paymentIntent?: Partial<string> & Partial<components["payment_intent"]>;
    ...
    session?: Partial<components["radar_review_resource_session"]> | null;
  };
  rule: {
  ...
  scheduledQueryRun: {
    ...
    dataLoadTime: number;
    error?: components["sigma_scheduled_query_run_error"];
    /** The file object representing the results of the query. */
    file?: Partial<components["file"]> | null;
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
  ...
  setupIntent: {
    ...
    lastSetupError?: Partial<components["api_errors"]> | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** ID of the multi use Mandate generated by the SetupIntent. */
    mandate?: (Partial<string> & Partial<components["mandate"]>) | null;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata?: { [key: string]: string };
    /** If present, this property tells you what actions you need to take in order for your customer to continue payment setup. */
    nextAction?: Partial<components["setup_intent_next_action"]> | null;
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "setup_intent";
    ...
    paymentMethodOptions?: Partial<
      components["setup_intent_payment_method_options"]
      > | null;
    /** The list of payment method types (e.g. card) that this SetupIntent is allowed to set up. */
    paymentMethodTypes: string[];
    /** ID of the single_use Mandate generated by the SetupIntent. */
    singleUseMandate?:
      | (Partial<string> & Partial<components["mandate"]>)
      | null;
  ...
  setupIntentNextAction: {
    redirectToUrl?: components["setup_intent_next_action_redirect_to_url"];
    /** Type of the next action to perform, one of `redirect_to_url` or `use_stripe_sdk`. */
    type: string;
  ...
  setupIntentPaymentMethodOptions: {
    card?: components["setup_intent_payment_method_options_card"];
  };
  ...
  shippingMethod: {
    ...
    deliveryEstimate?: Partial<components["delivery_estimate"]> | null;
    /** An arbitrary string attached to the object. Often useful for displaying to users. */
    description: string;
    /** Unique identifier for the object. */
    id: string;
  ...
  sku: {
    ...
    product: Partial<string> & Partial<components["product"]>;
    /** Time at which the object was last updated. Measured in seconds since the Unix epoch. */
    updated: number;
  };
  /**
   ...
   */
  source: {
    achCreditTransfer?: components["source_type_ach_credit_transfer"];
    achDebit?: components["source_type_ach_debit"];
    alipay?: components["source_type_alipay"];
    /** A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1, Japanese Yen being a zero-decimal currency) representing the total amount associated with the source. This is the amount for which the source will be chargeable once ready. Required for `single_use` sources. */
    amount?: number | null;
    auBecsDebit?: components["source_type_au_becs_debit"];
    bancontact?: components["source_type_bancontact"];
    card?: components["source_type_card"];
    cardPresent?: components["source_type_card_present"];
    /** The client secret of the source. Used for client-side retrieval using a publishable key. */
    clientSecret: string;
    codeVerification?: components["source_code_verification_flow"];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    ...
    customer?: string;
    eps?: components["source_type_eps"];
    /** The authentication `flow` of the source. `flow` is one of `redirect`, `receiver`, `code_verification`, `none`. */
    flow: string;
    giropay?: components["source_type_giropay"];
    /** Unique identifier for the object. */
    id: string;
    ideal?: components["source_type_ideal"];
    klarna?: components["source_type_klarna"];
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata?: { [key: string]: string } | null;
    multibanco?: components["source_type_multibanco"];
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "source";
    /** Information about the owner of the payment instrument that may be used or required by particular source types. */
    owner?: Partial<components["source_owner"]> | null;
    p24?: components["source_type_p24"];
    receiver?: components["source_receiver_flow"];
    redirect?: components["source_redirect_flow"];
    sepaDebit?: components["source_type_sepa_debit"];
    sofort?: components["source_type_sofort"];
    sourceOrder?: components["source_order"];
    /** Extra information about a source. This will appear on your customer's statement every time you charge the source. */
    statementDescriptor?: string | null;
    /** The status of the source, one of `canceled`, `chargeable`, `consumed`, `failed`, or `pending`. Only `chargeable` sources can be used to create a charge. */
    status: string;
    threeDSecure?: components["source_type_three_d_secure"];
    ...
    usage?: string | null;
    wechat?: components["source_type_wechat"];
  };
  ...
  sourceMandateNotification: {
    ...
    amount?: number | null;
    bacsDebit?: components["source_mandate_notification_bacs_debit_data"];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Unique identifier for the object. */
    id: string;
    ...
    reason: string;
    sepaDebit?: components["source_mandate_notification_sepa_debit_data"];
  ...
  sourceOrder: {
    ...
    items?: components["source_order_item"][] | null;
  ...
  sourceOwner: {
    ...
    verifiedAddress?: Partial<components["address"]> | null;
   ...
   */
  sourceTransaction: {
    achCreditTransfer?: components["source_transaction_ach_credit_transfer_data"];
    /** A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1, Japanese Yen being a zero-decimal currency) representing the amount your customer has pushed to the receiver. */
    amount: number;
    chfCreditTransfer?: components["source_transaction_chf_credit_transfer_data"];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
    gbpCreditTransfer?: components["source_transaction_gbp_credit_transfer_data"];
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    ...
    paperCheck?: components["source_transaction_paper_check_data"];
    sepaCreditTransfer?: components["source_transaction_sepa_credit_transfer_data"];
  ...
  subscription: {
    ...
    billingThresholds?: Partial<
      components["subscription_billing_thresholds"]
      > | null;
    ...
    items: {
      /** Details about each object. */
      data: components["subscription_item"][];
      /** True if this list has another page of items after this one that can be fetched. */
      hasMore: boolean;
      /** String representing the object's type. Objects of the same type share the same value. Always has the value `list`. */
      object: "list";
    ...
    latestInvoice?: (Partial<string> & Partial<components["invoice"]>) | null;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: string };
    ...
    pauseCollection?: Partial<
      components["subscriptions_resource_pause_collection"]
      > | null;
    /** Specifies an interval for how often to bill for any pending invoice items. It is analogous to calling [Create an invoice](https://stripe.com/docs/api#create_invoice) for the given subscription at the specified interval. */
    pendingInvoiceItemInterval?: Partial<
      components["subscription_pending_invoice_item_interval"]
      > | null;
    ...
    pendingUpdate?: Partial<
      components["subscriptions_resource_pending_update"]
      > | null;
    ...
    schedule?:
      | (Partial<string> & Partial<components["subscription_schedule"]>)
      | null;
  ...
  subscriptionItem: {
    ...
    billingThresholds?: Partial<
      components["subscription_item_billing_thresholds"]
      > | null;
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Unique identifier for the object. */
  ...
  subscriptionSchedule: {
    ...
    currentPhase?: Partial<
      components["subscription_schedule_current_phase"]
      > | null;
    /** ID of the customer who owns the subscription schedule. */
    customer: Partial<string> &
      Partial<components["customer"]> &
      Partial<components["deleted_customer"]>;
    defaultSettings: components["subscription_schedules_resource_default_settings"];
    ...
    phases: components["subscription_schedule_phase_configuration"][];
  ...
  subscriptionScheduleConfigurationItem: {
    ...
    plan: Partial<string> &
      Partial<components["plan"]> &
      Partial<components["deleted_plan"]>;
  ...
  subscriptionSchedulePhaseConfiguration: {
    ...
    coupon?:
      | (Partial<string> &
      Partial<components["coupon"]> &
      Partial<components["deleted_coupon"]>)
      | null;
    ...
    invoiceSettings?: Partial<
      components["invoice_setting_subscription_schedule_setting"]
      > | null;
    /** Plans to subscribe during this phase of the subscription schedule. */
    plans: components["subscription_schedule_configuration_item"][];
  ...
  subscriptionsResourcePendingUpdate: {
    ...
    subscriptionItems?: components["subscription_item"][] | null;
  ...
  taxId: {
    ...
    /** Value of the tax ID. */
    value: string;
    verification: components["tax_id_verification"];
  };
  taxIdVerification: {
   ...
   */
  token: {
    bankAccount?: components["bank_account"];
    card?: components["card"];
  ...
  transfer: {
    ...
    destination?: (Partial<string> & Partial<components["account"]>) | null;
    /** If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer. */
    destinationPayment?: Partial<string> & Partial<components["charge"]>;
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    ...
    reversals: {
      /** Details about each object. */
      data: components["transfer_reversal"][];
      /** True if this list has another page of items after this one that can be fetched. */
      hasMore: boolean;
      /** String representing the object's type. Objects of the same type share the same value. Always has the value `list`. */
      object: "list";
  ...
  transferReversal: {
    ...
    destinationPaymentRefund?:
      | (Partial<string> & Partial<components["refund"]>)
      | null;
    /** Unique identifier for the object. */
    id: string;
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    ...
    sourceRefund?: (Partial<string> & Partial<components["refund"]>) | null;
