...
export interface components {
  ...
  ProviderBody: {
    ownerId?: components["OptionalFlexID"];
    teamId?: components["OptionalID"];
    label: components["Label"];
    name: components["Name"];
    logoUrl?: components["LogoURL"];
    supportEmail?: string;
  ...
  UpdateProviderBody: {
    ownerId?: components["OptionalFlexID"];
    teamId?: components["OptionalID"];
    label?: components["OptionalLabel"];
    name?: components["OptionalName"];
    logoUrl?: components["OptionalLogoURL"];
  ...
  UpdateProvider: {
    id: components["ID"];
    body: components["UpdateProviderBody"];
  };
  UpdateProduct: {
    id: components["ID"];
    body: components["UpdateProductBody"];
  };
  UpdateProductBody: {
    name?: components["Name"];
    label?: components["Label"];
    logoUrl?: components["LogoURL"];
    listing?: components["ProductListing"];
    /** 140 character sentence positioning the product. */
    tagline?: string | null;
    /** A list of value propositions of the product. */
    valueProps?: components["ValueProp"][] | null;
    /** A list of getting started steps for the product */
    setupSteps?: string[] | null;
    images?: components["ProductImageURL"][] | null;
    supportEmail?: string | null;
    documentationUrl?: string | null;
    /**
    ...
    featureTypes?: components["FeatureType"][] | null;
    integration?: {
      provisioning?: components["ProductProvisioning"];
      baseUrl?: string | null;
      ssoUrl?: string | null;
      version?: "v1" | null;
      features?: {
        accessCode?: boolean | null;
        sso?: boolean | null;
        planChange?: boolean | null;
        credential?: ("none" | "single" | "multiple" | "unknown") | null;
      };
    } | null;
    /** An array of platform ids to restrict this product for. */
    platformIds?: components["ID"][] | null;
    tags?: components["ProductTags"];
  };
  UpdatePlan: {
    id: components["ID"];
    body: components["UpdatePlanBody"];
  };
  UpdatePlanBody: {
    name?: components["Name"];
    label?: components["Label"];
    state?: components["PlanState"];
    /** Used in conjuction with resizable_to to set or unset the list */
    hasResizeConstraints?: boolean | null;
    resizableTo?: components["PlanResizeList"];
    /** Array of Region IDs */
    regions?: components["ID"][] | null;
    /** Array of Feature Values */
    features?: components["FeatureValue"][] | null;
    /**
  ...
  FeatureType: {
     ...
     */
    measurable?: boolean;
    values?: components["FeatureValuesList"];
  };
  /**
   ...
   */
  FeatureValuesList: components["FeatureValueDetails"][] | null;
  FeatureValueDetails: {
    label: components["FeatureValueLabel"];
    name: components["Name"];
    /**
    ...
    price?: {
      ...
      formula?: components["PriceFormula"];
      /** Description explains how a feature is calculated to the user. */
      description?: string;
    };
    numericDetails?: components["FeatureNumericDetails"];
  };
  /**
  ...
  FeatureNumericDetails: {
    ...
    suffix?: string | null;
    costRanges?: components["FeatureNumericRange"][] | null;
  } | null;
  FeatureNumericRange: {
    /**
  ...
  FeatureValue: {
    feature: components["Label"];
    value: components["FeatureValueLabel"];
  };
  ValueProp: {
  ...
  ProductBody: {
    providerId: components["ID"];
    label: components["Label"];
    name: components["Name"];
    state: components["ProductState"];
    listing: components["ProductListing"];
    logoUrl: components["LogoURL"];
    /** 140 character sentence positioning the product. */
    tagline: string;
    /** A list of value propositions of the product. */
    valueProps: components["ValueProp"][];
    /** A list of getting started steps for the product */
    setupSteps?: string[] | null;
    images: components["ProductImageURL"][];
    supportEmail: string;
    documentationUrl: string;
    /**
     * URL to this Product's Terms of Service. If provided is true, then
    ...
    featureTypes: components["FeatureType"][];
    billing: {
    ...
    integration: {
      ...
      ssoUrl?: string | null;
      version: "v1";
      features: components["ProductIntegrationFeatures"];
    };
    tags?: components["ProductTags"];
  };
  Product: {
    ...
    version: number;
    type: "product";
    body: components["ProductBody"];
  };
  CreateProduct: {
    body: components["ProductBody"];
  };
  /** Array of Plan IDs that this Plan can be resized to, if null all will be assumed */
  PlanResizeList: components["ID"][] | null;
  PlanBody: {
    providerId: components["ID"];
    productId: components["ID"];
    name: components["Name"];
    label: components["Label"];
    state: components["PlanState"];
    resizableTo?: components["PlanResizeList"];
    /** Array of Region IDs */
    regions: components["ID"][];
    /** Array of Feature Values */
    features: components["FeatureValue"][];
    /**
     * The number of days a user gets as a free trial when subscribing to
     * this plan. Trials are valid only once per product; changing plans
     * or adding an additional subscription will not start a new trial.
  ...
  ExpandedPlanBody: components["PlanBody"] & {
    /** An array of feature definitions for the plan, as defined on the Product. */
    expandedFeatures: components["ExpandedFeature"][];
  ...
  ExpandedFeature: components["FeatureType"] & {
    /** The string value set for the feature on the plan, this should only be used if the value property is null. */
    valueString: string;
    value: components["FeatureValueDetails"];
  };
  Plan: {
    id: components["ID"];
    version: number;
    type: "plan";
    body: components["PlanBody"];
  };
  ExpandedPlan: {
    id: components["ID"];
    version: number;
    type: "plan";
    body: components["ExpandedPlanBody"];
  };
  CreatePlan: {
    body: components["PlanBody"];
  };
