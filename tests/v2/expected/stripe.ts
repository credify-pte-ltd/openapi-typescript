...
export interface definitions {
  ...
  apiErrors: {
    ...
    param?: string;
    paymentIntent?: definitions[""];
    paymentMethod?: definitions[""];
    setupIntent?: definitions[""];
    source?: definitions[""];
  ...
  charge: {
    ...
    paymentMethodDetails?: definitions[""];
  ...
  "checkout.session": {
    ...
    setupIntent?: string;
    shipping?: definitions[""];
    shippingAddressCollection?: definitions[""];
    /**
  ...
  countrySpec: {
    ...
    supportedBankAccountCurrencies: { [key: string]: any };
    ...
    verificationFields: definitions[""];
  };
  ...
  dispute: {
    ...
    balanceTransactions: definitions[""][];
  ...
  invoice: {
    ...
    taxPercent?: number;
    thresholdReason?: definitions[""];
    /** Total after discounts and taxes. */
    total: number;
    /** The aggregate amounts calculated per tax rate for all line items. */
    totalTaxAmounts?: definitions[""][];
  ...
  "issuing.authorization": {
    ...
    merchantData: definitions[""];
    /** Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. */
    metadata: { [key: string]: any };
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "issuing.authorization";
    pendingRequest?: definitions[""];
  ...
  "issuing.card": {
    ...
    replacementReason?: "damaged" | "expired" | "lost" | "stolen";
    shipping?: definitions[""];
    spendingControls: definitions[""];
  ...
  issuingCardholderRequirements: {
    ...
    disabledReason?: "listed" | "rejected.listed" | "under_review";
  ...
  legalEntityCompany: {
    address?: definitions[""];
    addressKana?: definitions[""];
    addressKanji?: definitions[""];
  ...
  legalEntityPersonVerification: {
    additionalDocument?: definitions[""];
  ...
  mandate: {
    customerAcceptance: definitions[""];
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    multiUse?: definitions[""];
    /** String representing the object's type. Objects of the same type share the same value. */
    object: "mandate";
    /** ID of the payment method associated with this mandate. */
    paymentMethod: string;
    paymentMethodDetails: definitions[""];
    singleUse?: definitions[""];
  ...
  mandatePaymentMethodDetails: {
    auBecsDebit?: definitions[""];
    card?: definitions[""];
    sepaDebit?: definitions[""];
  ...
  paymentIntent: {
    ...
    paymentMethod?: string;
    paymentMethodOptions?: definitions[""];
  ...
  paymentIntentPaymentMethodOptionsCard: {
    ...
    requestThreeDSecure?: "any" | "automatic" | "challenge_only";
  };
  /**
  ...
  paymentMethodCard: {
    ...
    /** Card funding type. Can be `credit`, `debit`, `prepaid`, or `unknown`. */
    funding: string;
    generatedFrom?: definitions[""];
    /** The last four digits of the card. */
    last4: string;
    threeDSecureUsage?: definitions[""];
    wallet?: definitions[""];
  };
  ...
  paymentMethodCardWallet: {
    amexExpressCheckout?: definitions[""];
    applePay?: definitions[""];
    /** (For tokenized numbers only.) The last four digits of the device account number. */
    dynamicLast4?: string;
    googlePay?: definitions[""];
    masterpass?: definitions[""];
    samsungPay?: definitions[""];
  ...
  paymentMethodDetails: {
    achCreditTransfer?: definitions[""];
    achDebit?: definitions[""];
    alipay?: definitions[""];
    auBecsDebit?: definitions[""];
    bancontact?: definitions[""];
    card?: definitions[""];
    cardPresent?: definitions[""];
    eps?: definitions[""];
    fpx?: definitions[""];
    ...
    ideal?: definitions[""];
    klarna?: definitions[""];
    multibanco?: definitions[""];
    p24?: definitions[""];
    sepaDebit?: definitions[""];
    sofort?: definitions[""];
    stripeAccount?: definitions[""];
    /**
  ...
  review: {
    ...
    closedReason?: "approved" | "disputed" | "refunded" | "refunded_as_fraud";
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Unique identifier for the object. */
    id: string;
  ...
  sourceTransaction: {
    ...
    amount: number;
    chfCreditTransfer?: definitions[""];
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    /** Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). */
    currency: string;
    gbpCreditTransfer?: definitions[""];
    /** Unique identifier for the object. */
    id: string;
    /** Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode. */
    livemode: boolean;
    ...
    paperCheck?: definitions[""];
    sepaCreditTransfer?: definitions[""];
  ...
  subscriptionSchedule: {
    ...
    /** Time at which the object was created. Measured in seconds since the Unix epoch. */
    created: number;
    currentPhase?: definitions[""];
    /** ID of the customer who owns the subscription schedule. */
    customer: string;
    defaultSettings: definitions[""];
